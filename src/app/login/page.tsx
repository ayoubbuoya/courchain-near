  ...
  return (
    <>
      ...
      <main className="min-h-screen tracking-normal text-center">
        <div
          className={`custom-linear-border shadow-custom-green rounded-xl w-[90%] sm:w-[80%] md:w-[60%] lg:w-[55%] xl:w-[43%] 2xl:w-[42%] mx-auto mt-8 md:mt-[5%]  font-bold backdrop-blur-[3.13rem]`}
        >
